...
const paymentCode = require('../lib/resources/paymentCode')
...
describe('Payments Code Module', () => {
  describe('Error with Module', () => {
    it('Expect error with schema missing argument', () => {
      assert.throws(paymentCode.create.bind(paymentCode, "Code", {
        reference: 'reference',
    ...
    it('Expect error missing code', () => {
      assert.throws(paymentCode.create.bind(paymentCode, {
        reference: 'reference',
        total: 3230,
        expiration: '01-12-2020'
      }), "Wrong type argument. [object Object] must be string, is object")
    })
  })

  describe('Successfully handle Payments Code', () => {
    it('Should create a Payment Code', () => {
      assert.isFulfilled(paymentCode.create("code", {
        reference: 'reference',
        total: 3230,
        expiration: '01-12-2020'
      }))
